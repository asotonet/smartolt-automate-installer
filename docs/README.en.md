...
> **Language**: English (this file) · [Versión en español](../README.md)
...
<p align="center">
  <img src="panel-overview.png" alt="SmartOLT Automate dashboard" width="900">
</p>
...
`./smartolt.sh install --yes` walks the wizard (or skips prompts in non-interactive mode):
...
- [Upstream project](https://github.com/asotonet/smartolt-automate) — full source
