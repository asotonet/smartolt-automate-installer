...
| `SMARTOLT_IMAGE` | `asoton/smartolt-automate:v0.2.3` | Backend + web tier image |
| `SMARTOLT_FRONTEND_IMAGE` | `asoton/smartolt-automate-frontend:v0.2.3` | Frontend image |
| `PROXY_IMAGE` | `asoton/smartolt-automate-proxy:v0.2.3` | Caddy image |
| `CERTBOT_IMAGE` | `asoton/smartolt-automate-certbot:v0.2.3` | Certbot image (46 DNS plugins) |
